...
class CallableFilter extends PreparedFilter implements CallableStatement {
	...
	@Override
	public void setAsciiStream(final String name, final java.io.InputStream input, final int length) throws SQLException {
	...
	@Override
	public void setBinaryStream(final String name, final java.io.InputStream input, final int length) throws SQLException {
	...
	@Override
	public void setCharacterStream(final String name, final java.io.Reader reader, final int length) throws SQLException {
	...
	@Override
	public void setObject(final String name, final Object object, final int sType, final int scale) throws SQLException {
	...
	@Override
	public void setTimestamp(final int index, final Timestamp timestamp, final java.util.Calendar cal) throws SQLException {
	...
	@Override
	public void setTimestamp(final String name, final Timestamp timestamp, final java.util.Calendar cal) throws SQLException {
